...
const API_BASE = (SCRIPT && SCRIPT.dataset.apiBase) || "[https://gbm-visual-chatbot.onrender.com](https://gbm-visual-chatbot.onrender.com)";
const COGNITION_LOGO_URL = "[https://7820107.fs1.hubspotusercontent-na1.net/hubfs/7820107/Cognition%20Button.png](https://7820107.fs1.hubspotusercontent-na1.net/hubfs/7820107/Cognition%20Button.png)";
const COGNITION_SMART_DATA_URL = "[https://www.greenbuildermedia.com/cognition-smart-data](https://www.greenbuildermedia.com/cognition-smart-data)";
...
panel.innerHTML = `     <div class="gbm-head">       <div class="gbm-brand">         <img src="${COGNITION_LOGO_URL}" alt="COGNITION">         <div>           <div class="gbm-title">COGNITION DeepDive</div>           <div class="gbm-subtitle">Make your query, and tap the power of our exclusive COGNITION SmartData, combining new research with 25 years of expertise in sustainable building.</div>         </div>       </div>       <button class="gbm-close" aria-label="Close">×</button>     </div>     <div class="gbm-body">       <div class="gbm-welcome">         <div class="gbm-welcome-title">Ask us anything about sustainable building.</div>         <div class="gbm-welcome-text">COGNITION DeepDive searches Green Builder Media articles, guides, magazines, videos, podcasts, and SmartData insights to produce an evidence-based answer with supporting resources.</div>       </div>       <div class="gbm-messages"></div>     </div>     <form class="gbm-form">       <input class="gbm-input" type="text" placeholder="Ask about heat pumps, electrification, resilience, codes, solar, water, materials..." />       <button class="gbm-submit" type="submit">Ask</button>     </form>
  `;
...
const fallback = type === "pdf" ? abs("/assets/covers/fallback-magazine.jpg") : COGNITION_LOGO_URL;

return `
  <a class="gbm-card" href="${esc(url)}" target="_blank" rel="noopener">
    <img src="${esc(img)}" alt="${esc(title)}" loading="lazy" onerror="this.onerror=null;this.src='${esc(fallback)}';" />
...
messages.innerHTML = `       ${renderQuestion(question)}       <div class="gbm-loading">         <span class="gbm-dot"></span><span class="gbm-dot"></span><span class="gbm-dot"></span>         <span>Searching Green Builder Media knowledge sources...</span>       </div>
    `;
}
...
const articles = allCards.filter(c => {
...
messages.innerHTML = `
  ...
  <div class="gbm-section-title">SUPPORTING RESOURCES</div>
